...
from .services.fixedroute import FixedRouteServiceConfig, fixed_route_services_from_dict, fixed_route_services_from_json
...
class SimulationRunner:
    ...
    def init_area(self, geojson_path: str, demands_path: str, fixedroute_json_path: str | None = None, fixedroute_data: dict | None = None):
        """
